<?php
$pdo = new PDO('mysql:host=localhost;dbname=bootstrap_projetos','root','');
        ...
        <div class="container">
            <div class="row">
                ...
                if( isset($_POST['editar_sobre'])){
                  ...
                  echo '<div class="alert alert-success" role="alert">Ocodigo HTML foi editado com sucesso!</div>';
                  $sobre = $pdo->prepare("SELECT * FROM `tb_sobre`");
                  $sobre->execute();
                  $sobre = $sobre->fetch()['sobre'];
                  ...
                  echo '<div class="alert alert-success" role="alert">O <b> membro </b> foi cadastrado!</div>';
                          ...
                          <div class="panel-body">
                            <table class="table">
                              ...
                              <tr>
                                ...
                                <td><button id membro="<?php echo $value['id']; ?>" type="button" class=" deletar-membro btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span>Excluir</button></td>
                              </tr>
